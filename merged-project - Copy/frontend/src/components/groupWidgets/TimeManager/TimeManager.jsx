    ...
    <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
      ...
      <div className="mb-6 pb-4 border-b border-gray-100">
        <h2 className="text-lg font-semibold text-gray-800 mb-1">
          ...
          {userRole === 'leader' && <span className="text-purple-600 text-sm ml-2">(Trưởng nhóm)</span>}
        </h2>
        <p className="text-sm text-gray-600">Chọn tháng và tuần để quản lý lịch của bạn</p>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-6">
        ...
        <div className="flex-1">
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-3">
            <div className="text-xs text-gray-600 mb-1">Thời gian đã chọn</div>
            <div className="text-lg font-semibold text-green-600">
              {statistics.totalSlots} khung giờ
            </div>
            {statistics.uniqueDays > 0 && (
              <div className="text-xs text-gray-500 mt-1">
                Trên {statistics.uniqueDays} ngày
              </div>
            )}
          </div>
        </div>
      ...
      <div className="mt-4 p-3 bg-blue-50 border-l-4 border-blue-500 rounded-r-md">
        <p className="text-sm text-blue-800">
          <strong>Hướng dẫn:</strong> Nhấp để chọn/bỏ chọn 1 ô. Kéo để chọn nhiều ô cùng lúc. 
          Thay đổi tự động được lưu.
